defmodule GigaChadWeb.Router do
  use GigaChadWeb, :router

  import GigaChadWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {GigaChadWeb.Layouts, :root}
  ...
  # scope "/api", GigaChadWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:giga_chad, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: GigaChadWeb.Telemetry
  ...
  scope "/", GigaChadWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{GigaChadWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", GigaChadWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{GigaChadWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", GigaChadWeb do
    ...
    live_session :current_user,
      on_mount: [{GigaChadWeb.UserAuth, :mount_current_user}] do
